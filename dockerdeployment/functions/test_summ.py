...
def test():
    test = pipeline("summarization", model="/models/summarization-pretrained")
    ARTICLE = """The tower is 324 metres (1,063 ft) tall, about the same height
    ...
    the Chrysler Building in New York City was finished in 1930. It was the
    first structure to reach a height of 300 metres. Due to the addition of
    a broadcasting aerial at the top of the tower in 1957, it is now taller
    ...
    return test(ARTICLE, max_length=130, min_length=30, do_sample=False)
